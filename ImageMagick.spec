...
Version  : 7.1.1.27
Release  : 285
URL      : https://imagemagick.org/archive/ImageMagick-7.1.1-27.tar.xz
Source0  : https://imagemagick.org/archive/ImageMagick-7.1.1-27.tar.xz
Source1  : https://imagemagick.org/archive/ImageMagick-7.1.1-27.tar.xz.asc
...
%prep
%setup -q -n ImageMagick-7.1.1-27
cd %{_builddir}/ImageMagick-7.1.1-27
%patch -P 1 -p1
pushd ..
cp -a ImageMagick-7.1.1-27 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705862089
...
cp %{_builddir}/ImageMagick-7.1.1-27/Magick++/LICENSE %{buildroot}/usr/share/package-licenses/ImageMagick/e35708150f9609098e95bf25b6b5d4908f999666 || :
cp %{_builddir}/ImageMagick-7.1.1-27/NOTICE %{buildroot}/usr/share/package-licenses/ImageMagick/023310790971bdf976590c24416fcb00ec9785ec || :
cp %{_builddir}/ImageMagick-7.1.1-27/www/Magick++/COPYING %{buildroot}/usr/share/package-licenses/ImageMagick/9fbc78241e625956288a5ef6797d540b58197565 || :
pushd ../buildavx2/
%make_install_v3
popd
%make_install
