...
Source0  : https://www.imagemagick.org/download/ImageMagick-7.1.0-22.tar.xz
Source1  : https://www.imagemagick.org/download/ImageMagick-7.1.0-22.tar.xz.asc
...
%prep
%setup -q -n ImageMagick-7.1.0-22
cd %{_builddir}/ImageMagick-7.1.0-22
%patch1 -p1
%patch2 -p1
pushd ..
cp -a ImageMagick-7.1.0-22 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643581807
...
cp %{_builddir}/ImageMagick-7.1.0-22/LICENSE %{buildroot}/usr/share/package-licenses/ImageMagick/7b06ae10608c179f80baf785db16ba5024423074
cp %{_builddir}/ImageMagick-7.1.0-22/Magick++/LICENSE %{buildroot}/usr/share/package-licenses/ImageMagick/e35708150f9609098e95bf25b6b5d4908f999666
cp %{_builddir}/ImageMagick-7.1.0-22/www/Magick++/COPYING %{buildroot}/usr/share/package-licenses/ImageMagick/9fbc78241e625956288a5ef6797d540b58197565
pushd ../buildavx2/
%make_install_v3
popd
%make_install
