...
Version  : 7.0.10.49
Release  : 157
URL      : https://www.imagemagick.org/download/ImageMagick-7.0.10-49.tar.xz
Source0  : https://www.imagemagick.org/download/ImageMagick-7.0.10-49.tar.xz
Source1  : https://www.imagemagick.org/download/ImageMagick-7.0.10-49.tar.xz.asc
...
%prep
%setup -q -n ImageMagick-7.0.10-49
cd %{_builddir}/ImageMagick-7.0.10-49
%patch1 -p1
%patch2 -p1
pushd ..
cp -a ImageMagick-7.0.10-49 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608135023
...
cp %{_builddir}/ImageMagick-7.0.10-49/LICENSE %{buildroot}/usr/share/package-licenses/ImageMagick/e66e0d42f7f5b1a92ac56137e97154b9a15933ea
cp %{_builddir}/ImageMagick-7.0.10-49/Magick++/LICENSE %{buildroot}/usr/share/package-licenses/ImageMagick/e35708150f9609098e95bf25b6b5d4908f999666
cp %{_builddir}/ImageMagick-7.0.10-49/NOTICE %{buildroot}/usr/share/package-licenses/ImageMagick/74a4b5e5b4221d5f9b27a3efe665a27746229f79
cp %{_builddir}/ImageMagick-7.0.10-49/www/Magick++/COPYING %{buildroot}/usr/share/package-licenses/ImageMagick/9fbc78241e625956288a5ef6797d540b58197565
pushd ../buildavx2/
%make_install_avx2
popd
%make_install
