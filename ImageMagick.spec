...
Version  : 7.1.0.54
Release  : 251
URL      : https://imagemagick.org/archive/ImageMagick-7.1.0-54.tar.xz
Source0  : https://imagemagick.org/archive/ImageMagick-7.1.0-54.tar.xz
Source1  : https://imagemagick.org/archive/ImageMagick-7.1.0-54.tar.xz.asc
...
%prep
%setup -q -n ImageMagick-7.1.0-54
cd %{_builddir}/ImageMagick-7.1.0-54
%patch1 -p1
%patch2 -p1
pushd ..
cp -a ImageMagick-7.1.0-54 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670871905
...
cp %{_builddir}/ImageMagick-7.1.0-54/LICENSE %{buildroot}/usr/share/package-licenses/ImageMagick/1e9541045365ca92e2d6c29a56df7616fa6cf49d || :
cp %{_builddir}/ImageMagick-7.1.0-54/Magick++/LICENSE %{buildroot}/usr/share/package-licenses/ImageMagick/e35708150f9609098e95bf25b6b5d4908f999666 || :
cp %{_builddir}/ImageMagick-7.1.0-54/NOTICE %{buildroot}/usr/share/package-licenses/ImageMagick/023310790971bdf976590c24416fcb00ec9785ec || :
cp %{_builddir}/ImageMagick-7.1.0-54/www/Magick++/COPYING %{buildroot}/usr/share/package-licenses/ImageMagick/9fbc78241e625956288a5ef6797d540b58197565 || :
pushd ../buildavx2/
%make_install_v3
popd
%make_install
