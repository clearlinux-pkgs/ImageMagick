...
Source0  : https://www.imagemagick.org/download/ImageMagick-7.0.10-48.tar.xz
Source1  : https://www.imagemagick.org/download/ImageMagick-7.0.10-48.tar.xz.asc
...
%prep
%setup -q -n ImageMagick-7.0.10-48
cd %{_builddir}/ImageMagick-7.0.10-48
%patch1 -p1
%patch2 -p1
pushd ..
cp -a ImageMagick-7.0.10-48 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607645897
...
cp %{_builddir}/ImageMagick-7.0.10-48/LICENSE %{buildroot}/usr/share/package-licenses/ImageMagick/e66e0d42f7f5b1a92ac56137e97154b9a15933ea
cp %{_builddir}/ImageMagick-7.0.10-48/Magick++/LICENSE %{buildroot}/usr/share/package-licenses/ImageMagick/e35708150f9609098e95bf25b6b5d4908f999666
cp %{_builddir}/ImageMagick-7.0.10-48/NOTICE %{buildroot}/usr/share/package-licenses/ImageMagick/74a4b5e5b4221d5f9b27a3efe665a27746229f79
cp %{_builddir}/ImageMagick-7.0.10-48/www/Magick++/COPYING %{buildroot}/usr/share/package-licenses/ImageMagick/9fbc78241e625956288a5ef6797d540b58197565
pushd ../buildavx2/
%make_install_avx2
popd
%make_install
