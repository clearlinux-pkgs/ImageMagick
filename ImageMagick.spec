...
Source0  : https://imagemagick.org/archive/ImageMagick-7.1.1-39.tar.gz
Source1  : https://imagemagick.org/archive/ImageMagick-7.1.1-39.tar.gz.asc
...
%setup -q -n ImageMagick-7.1.1-39
cd %{_builddir}/ImageMagick-7.1.1-39
%patch -P 1 -p1
pushd ..
cp -a ImageMagick-7.1.1-39 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729118079
...
cp %{_builddir}/ImageMagick-7.1.1-39/Magick++/LICENSE %{buildroot}/usr/share/package-licenses/ImageMagick/e35708150f9609098e95bf25b6b5d4908f999666 || :
cp %{_builddir}/ImageMagick-7.1.1-39/NOTICE %{buildroot}/usr/share/package-licenses/ImageMagick/023310790971bdf976590c24416fcb00ec9785ec || :
cp %{_builddir}/ImageMagick-7.1.1-39/www/Magick++/COPYING %{buildroot}/usr/share/package-licenses/ImageMagick/9fbc78241e625956288a5ef6797d540b58197565 || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
%make_install_v3
